...
def google():
    webbrowser.open_new_tab(url="https://accounts.google.com/v3/signin/identifier?dsh=S-167259299%3A1686578667203817&elo=1&ffgf=1&ifkv=Af_xneH-bdvOJ9fmKxFNh7xZQDuK2y_-k8JCVj-ONulm8msLtAb9eM4S8k18p-dMxwCFlaU83OjT&flowName=GlifWebSignIn&flowEntry=ServiceLogin")

def facebook():
    webbrowser.open_new_tab(url="https://www.facebook.com/login/?privacy_mutation_token=eyJ0eXBlIjowLCJjcmVhdGlvbl90aW1lIjoxNjg2NTc4NzIyLCJjYWxsc2l0ZV9pZCI6MjY5NTQ4NDUzMDcyMDk1MX0%3D")
...
def signupwindow():
    ...
    def googlesignup():
        webbrowser.open_new_tab(url="https://accounts.google.com/signup/v2/createaccount?flowName=GlifWebSignIn&flowEntry=SignUp")

    def facebooksignup():
        webbrowser.open_new_tab(url="https://www.facebook.com/r.php?locale=en_GB&display=page")
    ...
    photoadd = Button(in_frame,command=googlesignup,background="white",border=0,padx=25,font=("@Malgun Gothic" , 12, "bold") , fg="red",text = 'Google', image = photoimage,compound = LEFT)
    ...
    photoadd1 = Button(in_frame,command=facebooksignup,background="white",border=0,padx=19,font=("@Malgun Gothic" , 12, "bold") , fg="blue",text = 'Facebook', image = photo1image,compound = LEFT)
...
photoimage = photo.subsample(3, 3)
photoadd = Button(in_frame,command=google,background="white",border=0,padx=25,font=("@Malgun Gothic" , 12, "bold") , fg="red",text = 'Google', image = photoimage,compound = LEFT)
photoadd.place(x=20, y=450)
...
photo1image = photo1.subsample(3, 3)
photoadd1 = Button(in_frame,command=facebook,background="white",border=0,padx=19,font=("@Malgun Gothic" , 12, "bold") , fg="blue",text = 'Facebook', image = photo1image,compound = LEFT)
photoadd1.place(x=220, y=450)
